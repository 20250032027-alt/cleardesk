...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/overwhelmed`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/just-diagnosed`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/screen-break`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${base}/articles/adhd-sleep`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/articles/doomscrolling`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/articles/adhd-exercise`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/articles/adhd-eating`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
